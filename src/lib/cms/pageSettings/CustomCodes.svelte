...
<div class="collapse-group">
    ...
    <div class="collapse-content">
        <div class="input-holder">
            <p class="label">Inside {`<head>`} tag</p>

            <textarea type="text" bind:value={selectedPage.customCode.headTag}></textarea>
        </div>

        <div class="input-holder">
            <p class="label">Inside {`<footer>`} tag</p>

            <textarea type="text" bind:value={selectedPage.customCode.footerTag}></textarea>
        </div>
    </div>
    {/if}
</div>
